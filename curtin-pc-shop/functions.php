...
add_action( 'wp_enqueue_scripts', function () {
	...
	// NOTE: the CSS/JS filenames carry the version (curtin-266.*) because the
	...
	wp_enqueue_style(
		'cpc-main',
		get_stylesheet_directory_uri() . '/assets/css/curtin-266.css',
		array( 'cpc-fonts' ),
		CPC_VERSION
	);
	...
	wp_enqueue_script(
		'cpc-ui',
		get_stylesheet_directory_uri() . '/assets/js/curtin-266.js',
		array(),
		CPC_VERSION,
		true
	);
